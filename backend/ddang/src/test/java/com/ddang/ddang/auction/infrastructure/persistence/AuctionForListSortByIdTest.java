...
class AuctionForListSortByIdTest extends AuctionForListSortByIdFixture {
    ...
    void 페이지_크기_3_두번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            ...
            softAssertions.assertThat(actual.getContent().get(2)).isEqualTo(두번째_페이지_인덱스_2_1일_후_마감_id_5);
            softAssertions.assertThat(actual.hasNext()).isTrue();
        });
    }
    ...
    void 페이지_크기_3_세번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            softAssertions.assertThat(actual).hasSize(3);
            softAssertions.assertThat(actual.getContent().get(0)).isEqualTo(세번째_페이지_인덱스_0_2일_후_마감_id_4);
            softAssertions.assertThat(actual.getContent().get(1)).isEqualTo(세번째_페이지_인덱스_1_3일_후_마감_id_3);
    ...
    void 페이지_크기_3_다섯번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            ...
            softAssertions.assertThat(actual.getContent().get(2)).isEqualTo(다섯번째_페이지_인덱스_2_2일_전_마감_id_6);
            softAssertions.assertThat(actual.hasNext()).isTrue();
        });
    }
    ...
    void 페이지_크기_3_여섯번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            ...
            softAssertions.assertThat(actual.getContent().get(0)).isEqualTo(여섯번째_페이지_인덱스_0_5일_전_마감_id_1);
