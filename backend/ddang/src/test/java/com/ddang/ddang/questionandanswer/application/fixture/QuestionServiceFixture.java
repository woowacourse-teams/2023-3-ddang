...
public class QuestionServiceFixture {
    ...
    void setUp() {
        ...
        final ReadUserInQuestionAndAnswerDto 판매자_정보_dto = ReadUserInQuestionAndAnswerDto.from(판매자);
        final ReadUserInQuestionAndAnswerDto 질문자_정보_dto = ReadUserInQuestionAndAnswerDto.from(질문자);
