...
public class AuctionReportServiceFixture {
    ...
    void setUp() {
        ...
        경매_신고1 = new AuctionReport(이미_신고한_신고자1, 경매, "신고합니다");
        경매_신고2 = new AuctionReport(이미_신고한_신고자2, 경매, "신고합니다");
        경매_신고3 = new AuctionReport(이미_신고한_신고자3, 경매, "신고합니다");
