...
public class AuctionReviewControllerFixture extends CommonControllerSliceTest {
    ...
    protected Long 판매자_프로필_이미지_아이디 = 1L;
    protected ReadUserInReviewDto 판매자 = new ReadUserInReviewDto(1L, "판매자", 판매자_프로필_이미지_아이디, 5.0f, "12347");
    protected Long 구매자가_판매자에게_받은_평가_아이디 = 1L;
    protected ReadReviewDto 구매자가_판매자1에게_받은_평가 =
            new ReadReviewDto(구매자가_판매자에게_받은_평가_아이디, 판매자, "친절하다.", 5.0f, LocalDateTime.now());
