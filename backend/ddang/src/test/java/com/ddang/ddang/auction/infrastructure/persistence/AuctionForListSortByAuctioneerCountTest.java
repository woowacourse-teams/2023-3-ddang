...
class AuctionForListSortByAuctioneerCountTest extends AuctionForListSortByAuctioneerCountFixture {
    ...
    void 페이지_크기_3_세번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            softAssertions.assertThat(actual).hasSize(3);
            softAssertions.assertThat(actual.getContent().get(0)).isEqualTo(세번째_페이지_인덱스_0_참여자_4_1일_후_마감_id_5);
            softAssertions.assertThat(actual.getContent().get(1)).isEqualTo(세번째_페이지_인덱스_1_참여자_4_3일_후_마감_id_3);
            softAssertions.assertThat(actual.getContent().get(2)).isEqualTo(세번째_페이지_인덱스_2_참여자_1_4일_후_마감_id_2);
            softAssertions.assertThat(actual.hasNext()).isTrue();
        });
    }
    ...
    void 페이지_크기_3_네번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            softAssertions.assertThat(actual).hasSize(3);
            softAssertions.assertThat(actual.getContent().get(0)).isEqualTo(네번째_페이지_인덱스_0_참여자_8_2일_전_마감_id_6);
            softAssertions.assertThat(actual.getContent().get(1)).isEqualTo(네번째_페이지_인덱스_1_참여자_6_4일_전_마감_id_16);
            softAssertions.assertThat(actual.getContent().get(2)).isEqualTo(네번째_페이지_인덱스_2_참여자_6_4일_전_마감_id_13);
            softAssertions.assertThat(actual.hasNext()).isTrue();
        });
    }
    ...
    void 페이지_크기_3_다섯번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            softAssertions.assertThat(actual).hasSize(3);
            softAssertions.assertThat(actual.getContent().get(0)).isEqualTo(다섯번째_페이지_인덱스_0_참여자_6_4일_전_마감_id_9);
            softAssertions.assertThat(actual.getContent().get(1)).isEqualTo(다섯번째_페이지_인덱스_1_참여자_6_4일_전_마감_id_8);
            softAssertions.assertThat(actual.getContent().get(2)).isEqualTo(다섯번째_페이지_인덱스_2_참여자_3_4일_전_마감_id_7);
            softAssertions.assertThat(actual.hasNext()).isTrue();
        });
    }
    ...
    void 페이지_크기_3_여섯번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            ...
            softAssertions.assertThat(actual.getContent().get(0)).isEqualTo(여섯번째_페이지_인덱스_0_참여자_2_5일_전_마감_id_1);
