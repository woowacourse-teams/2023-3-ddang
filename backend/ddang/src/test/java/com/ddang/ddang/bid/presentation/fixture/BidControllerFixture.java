...
public class BidControllerFixture extends CommonControllerSliceTest {
    ...
    protected ReadBidDto 입찰_정보_dto1 = new ReadBidDto("사용자1", "store-name.png", false, 10_000, LocalDateTime.now());
    protected ReadBidDto 입찰_정보_dto2 = new ReadBidDto("사용자2", "store-name.png", false, 12_000, LocalDateTime.now());
}
