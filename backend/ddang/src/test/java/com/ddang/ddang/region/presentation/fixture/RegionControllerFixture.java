...
public class RegionControllerFixture extends CommonControllerSliceTest {
    ...
    protected ReadRegionDto 서울특별시_강남구 = new ReadRegionDto(4L, "서울특별시 강남구");
    protected ReadRegionDto 서울특별시_강동구 = new ReadRegionDto(5L, "서울특별시 강동구");
    protected ReadRegionDto 세번째_지역이_없는_두번째_지역 = new ReadRegionDto(6L, "세번째 지역이 없는 두번째 지역");
    protected ReadRegionDto 서울특별시_강남구_개포1동 = new ReadRegionDto(7L, "서울특별시 강남구 개포1동");
    protected ReadRegionDto 서울특별시_강남구_개포2동 = new ReadRegionDto(8L, "서울특별시 강남구 개포2동");
}
