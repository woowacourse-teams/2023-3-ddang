...
public class QuerydslChatRoomAndMessageAndImageRepositoryImplFixture {
    ...
    protected User 엔초 = User.builder()
                            ...
                            .oauthId("12346")
                            .build();
    private User 제이미 = User.builder()
                           .name("제이미")
                           .profileImage(프로필_이미지)
                           .reliability(4.7d)
                           .oauthId("12347")
                           .build();
    private User 지토 = User.builder()
                          .name("지토")
                          .profileImage(프로필_이미지)
                          .reliability(4.7d)
                          .oauthId("12348")
                          .build();
    protected AuctionImage 메리의_경매_대표_이미지 = new AuctionImage("메리의_경매_대표_이미지.png", "메리의_경매_대표_이미지.png");
    ...
    private Auction 메리의_경매 = Auction.builder()
                                    .seller(메리)
                                    .title("메리 맥북")
                                    ...
                                    .build();
    private Auction 엔초의_경매 = Auction.builder()
                                    .seller(엔초)
                                    .title("엔초 맥북")
                                    ...
                                    .closingTime(LocalDateTime.now())
                                    .build();
    private Auction 제이미의_경매 = Auction.builder()
                                     .seller(제이미)
                                     .title("제이미 맥북")
                                     ...
                                     .closingTime(LocalDateTime.now())
                                     .build();
    private Bid 엔초가_메리_경매에_입찰 = new Bid(메리의_경매, 엔초, new BidPrice(15_000));
    private Bid 지토가_엔초_경매에_입찰 = new Bid(엔초의_경매, 지토, new BidPrice(15_000));
    private Bid 엔초가_제이미_경매에_입찰 = new Bid(제이미의_경매, 엔초, new BidPrice(15_000));

    protected ChatRoom 메리_엔초_채팅방 = new ChatRoom(메리의_경매, 엔초);
    protected ChatRoom 엔초_지토_채팅방 = new ChatRoom(엔초의_경매, 지토);
    protected ChatRoom 제이미_엔초_채팅방 = new ChatRoom(제이미의_경매, 엔초);

    private Message 제이미가_엔초에게_1시에_보낸_쪽지 = Message.builder()
                                                 .chatRoom(제이미_엔초_채팅방)
                                                 .contents("제이미가 엔초에게 1시애 보낸 쪽지")
                                                 .writer(제이미)
                                                 .receiver(엔초)
                                                 .build();
    private Message 엔초가_지토에게_2시에_보낸_쪽지 = Message.builder()
                                                .chatRoom(엔초_지토_채팅방)
                                                .contents("엔초가 지토에게 2시애 보낸 쪽지")
                                                .writer(엔초)
                                                .receiver(지토)
                                                .build();
    protected Message 메리가_엔초에게_3시에_보낸_쪽지 = Message.builder()
                                                  .chatRoom(메리_엔초_채팅방)
                                                  .contents("메리가 엔초에게 3시에 보낸 쪽지")
                                                  .writer(엔초)
                                                  .receiver(지토)
                                                  .build();
    protected Message 제이미가_엔초에게_4시에_보낸_쪽지 = Message.builder()
                                                   .chatRoom(제이미_엔초_채팅방)
                                                   .contents("제이미가 엔초에게 4시애 보낸 쪽지")
                                                   .writer(제이미)
                                                   .receiver(엔초)
                                                   .build();
    protected Message 엔초가_지토에게_5시에_보낸_쪽지 = Message.builder()
                                                  .chatRoom(엔초_지토_채팅방)
    ...
    void setUp() {
        ...
        auctionImageRepository.saveAll(
                List.of(
                        메리의_경매_대표_이미지, 메리의_대표_이미지가_아닌_경매_이미지,
