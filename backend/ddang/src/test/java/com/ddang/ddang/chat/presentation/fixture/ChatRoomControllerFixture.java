...
public class ChatRoomControllerFixture extends CommonControllerSliceTest {
    ...
    private final ReadAuctionInChatRoomDto 조회용_경매_dto2 = new ReadAuctionInChatRoomDto(2L, "경매2", 20_000, 1L);
    ...
    protected ReadChatRoomWithLastMessageDto 조회용_채팅방2 = new ReadChatRoomWithLastMessageDto(2L, 조회용_경매_dto2, 구매자2, new ReadLastMessageDto(1L, LocalDateTime.now(), 판매자, 구매자2, "메시지2"), true);
