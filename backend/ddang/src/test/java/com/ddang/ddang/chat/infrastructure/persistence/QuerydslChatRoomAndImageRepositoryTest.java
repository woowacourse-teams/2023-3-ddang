...
import com.ddang.ddang.chat.infrastructure.persistence.fixture.QuerydslChatRoomAndImageRepositoryFixture;
...
class QuerydslChatRoomAndImageRepositoryTest extends QuerydslChatRoomAndImageRepositoryFixture {
    ...
    void setUp(@Autowired final JPAQueryFactory queryFactory) {
        querydslChatRoomAndImageRepository = new QuerydslChatRoomAndImageRepository(queryFactory);
    }
