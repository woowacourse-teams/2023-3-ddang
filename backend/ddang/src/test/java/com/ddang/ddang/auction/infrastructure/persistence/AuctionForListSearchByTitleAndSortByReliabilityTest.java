...
import com.ddang.ddang.auction.infrastructure.persistence.fixture.AuctionForListSearchByTitleAndSortByReliabilityFixture;
...
class AuctionForListSearchByTitleAndSortByReliabilityTest extends AuctionForListSearchByTitleAndSortByReliabilityFixture {
    ...
    void 페이지_크기_3_세번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            ...
            softAssertions.assertThat(actual.getContent().get(2)).isEqualTo(세번째_페이지_인덱스_2_신뢰도_4_7_4일_전_마감_id_7);
            softAssertions.assertThat(actual.hasNext()).isTrue();
        });
    }
    ...
    void 페이지_크기_3_네번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            softAssertions.assertThat(actual).hasSize(3);
            softAssertions.assertThat(actual.getContent().get(0)).isEqualTo(네번째_페이지_인덱스_0_신뢰도_4_7_5일_전_마감_id_1);
            softAssertions.assertThat(actual.getContent().get(1)).isEqualTo(네번째_페이지_인덱스_1_신뢰도_3_5_4일_전_마감_id_16);
            softAssertions.assertThat(actual.getContent().get(2)).isEqualTo(네번째_페이지_인덱스_2_신뢰도_3_5_4일_전_마감_id_8);
            softAssertions.assertThat(actual.hasNext()).isTrue();
        });
    }
    ...
    void 페이지_크기_3_다섯번째_페이지_요청_테스트() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            ...
            softAssertions.assertThat(actual.getContent().get(0)).isEqualTo(다섯번째_페이지_인덱스_0_신뢰도_2_1_4일_전_마감_id_13);
            softAssertions.assertThat(actual.getContent().get(1)).isEqualTo(다섯번째_페이지_인덱스_1_신뢰도_2_1_4일_전_마감_id_9);
