...
public class ReviewControllerFixture extends CommonControllerSliceTest {
    ...
    private Long 판매자1_프로필_이미지_아이디 = 1L;
    private Long 판매자2_프로필_이미지_아이디 = 2L;
    private Long 구매자_프로필_이미지_아이디 = 3L;
    private ReadUserInReviewDto 판매자1 = new ReadUserInReviewDto(1L, "판매자1", 판매자1_프로필_이미지_아이디, 5.0f, "12347");
    private ReadUserInReviewDto 판매자2 = new ReadUserInReviewDto(2L, "판매자2", 판매자2_프로필_이미지_아이디, 5.0f, "12348");
    protected ReadUserInReviewDto 구매자 = new ReadUserInReviewDto(3L, "구매자", 구매자_프로필_이미지_아이디, 5.0f, "12349");
    ...
    protected ReadReviewDto 구매자가_판매자1에게_받은_평가 =
            new ReadReviewDto(구매자가_판매자1에게_받은_평가_아이디, 판매자1, "친절하다.", 5.0f, LocalDateTime.now());
    protected ReadReviewDto 구매자가_판매자2에게_받은_평가 =
            new ReadReviewDto(구매자가_판매자2에게_받은_평가_아이디, 판매자2, "친절하다.", 5.0f, LocalDateTime.now());
