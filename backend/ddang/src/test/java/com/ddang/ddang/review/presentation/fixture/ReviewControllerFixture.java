...
public class ReviewControllerFixture extends CommonControllerSliceTest {
    ...
    private String 판매자1_프로필_이미지_저장_이름 = "profile_image1.png";
    private String 판매자2_프로필_이미지_저장_이름 = "profile_image2.png";
    private String 구매자_프로필_이미지_저장_이름 = "profile_image3.png";
    private ReadUserInReviewDto 판매자1 = new ReadUserInReviewDto(1L, "판매자1", 판매자1_프로필_이미지_저장_이름, 5.0d, "12347");
    private ReadUserInReviewDto 판매자2 = new ReadUserInReviewDto(2L, "판매자2", 판매자2_프로필_이미지_저장_이름, 5.0d, "12348");
    protected ReadUserInReviewDto 구매자 = new ReadUserInReviewDto(3L, "구매자", 구매자_프로필_이미지_저장_이름, 5.0d, "12349");
    ...
    protected ReadReviewDto 구매자가_판매자2에게_받은_평가 =
            new ReadReviewDto(구매자가_판매자2에게_받은_평가_아이디, 판매자2, "친절하다.", 5.0d, LocalDateTime.now());
