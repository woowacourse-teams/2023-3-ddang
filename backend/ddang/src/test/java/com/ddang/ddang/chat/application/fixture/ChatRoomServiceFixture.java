...
import com.ddang.ddang.chat.application.dto.response.ReadMultipleChatRoomDto.PartnerInfoDto;
...
public class ChatRoomServiceFixture {
    ...
    void setUp() {
        ...
        엔초_채팅_목록의_제이미_엔초_채팅방_정보 = new ReadMultipleChatRoomDto(
                제이미_엔초_채팅방.getId(),
                new SimpleAuctionInfoDto(판매자_제이미_구매자_엔초_경매.getId(), 판매자_제이미_구매자_엔초_경매.getTitle(), 판매자_제이미_구매자_엔초_경매.getLastBid().getPrice().getValue(), 판매자_제이미_구매자_엔초_경매.getThumbnailImageStoreName()),
                new PartnerInfoDto(제이미.getId(), 제이미.getName(), 제이미.getProfileImageStoreName(), 제이미.getReliability().getValue(), 제이미.isDeleted()),
                new MessageInfoDto(제이미가_엔초에게_2시에_보낸_쪽지.getCreatedTime(), 제이미가_엔초에게_2시에_보낸_쪽지.getContent()),
                1L,
                true
        );
        엔초_채팅_목록의_엔초_지토_채팅방_정보 = new ReadMultipleChatRoomDto(
                엔초_지토_채팅방.getId(),
                new SimpleAuctionInfoDto(판매자_엔초_구매자_지토_경매.getId(), 판매자_엔초_구매자_지토_경매.getTitle(), 판매자_엔초_구매자_지토_경매.getLastBid().getPrice().getValue(), 판매자_엔초_구매자_지토_경매.getThumbnailImageStoreName()),
                new PartnerInfoDto(지토.getId(), 지토.getName(), 지토.getProfileImageStoreName(), 지토.getReliability().getValue(), 지토.isDeleted()),
                new MessageInfoDto(엔초가_지토에게_1시에_보낸_쪽지.getCreatedTime(), 엔초가_지토에게_1시에_보낸_쪽지.getContent()),
                1L,
                true
        );
    }
