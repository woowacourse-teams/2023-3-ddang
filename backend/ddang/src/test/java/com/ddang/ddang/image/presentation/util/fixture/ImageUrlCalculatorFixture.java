...
public class ImageUrlCalculatorFixture {
    ...
    protected String 프로필_이미지_절대_URL = "http://3-ddang.store/users/images/";
    ...
    protected String 프로필_기본_이미지_전체_URL = 프로필_이미지_절대_URL + "1L";
    protected String 경매_이미지_절대_URL = "http://3-ddang.store/auctions/images/";
