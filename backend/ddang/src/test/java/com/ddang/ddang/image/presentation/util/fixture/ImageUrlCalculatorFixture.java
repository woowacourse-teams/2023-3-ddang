...
public class ImageUrlCalculatorFixture {
    ...
    protected String 프로필_이미지_아이디가_null = null;
    protected String 프로필_이미지_전체_URL = 프로필_이미지_절대_URL + 프로필_이미지_이름;
    ...
    protected String 경매_이미지_전체_URL = 경매_이미지_절대_URL + 경매_이미지_이름;
}
