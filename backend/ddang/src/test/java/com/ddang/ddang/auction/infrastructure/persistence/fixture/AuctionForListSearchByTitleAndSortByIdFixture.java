...
public class AuctionForListSearchByTitleAndSortByIdFixture extends QuerydslAuctionRepositoryImplForListFixture {
    ...
    protected Auction 네번째_페이지_인덱스_1_id_4;
    protected Auction 네번째_페이지_인덱스_2_id_3;
    protected Auction 다섯번째_페이지_인덱스_0_id_2;
    protected Auction 다섯번째_페이지_인덱스_1_id_1;
    ...
    void fixtureSetUp() {
        ...
        네번째_페이지_인덱스_1_id_4 = 경매4;
        네번째_페이지_인덱스_2_id_3 = 경매3;
        다섯번째_페이지_인덱스_0_id_2 = 경매2;
        다섯번째_페이지_인덱스_1_id_1 = 경매1;
    }
}
