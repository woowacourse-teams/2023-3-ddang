...
==== 요청
include::{snippets}/review-controller-test/사용자가_경매_거래에_작성한_평가를_조회한다/http-request.adoc[]
include::{snippets}/review-controller-test/사용자가_경매_거래에_작성한_평가를_조회한다/query-parameters.adoc[]
include::{snippets}/review-controller-test/사용자가_경매_거래에_작성한_평가를_조회한다/request-headers.adoc[]

==== 응답
include::{snippets}/review-controller-test/사용자가_경매_거래에_작성한_평가를_조회한다/http-response.adoc[]
include::{snippets}/review-controller-test/사용자가_경매_거래에_작성한_평가를_조회한다/response-fields.adoc[]
